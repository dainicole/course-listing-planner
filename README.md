...
<br>2. The user can also filter the entire list of courses by taken/not taken courses as well as want to take/not wanted courses. Otherwise the default option to display all courses is set. 
